...
| OSSF Scorecard ≥ 7.5 | docs/SCORECARD-v1.0.0.md + .github/workflows/scorecard.yml | github.com/ossf/scorecard |
...
| Mutation testing baseline | docs/FUZZING.md | github.com/sourcefrog/cargo-mutants |
| Adversarial eval (ML) | crates/amore-eval/src/bin/adversarial_eval.rs + docs/ADVERSARIAL-EVAL.md | owasp.org/www-project-top-10-for-large-language-model-applications |
...
| Canary release (3-stage) | docs/ROLLBACK-RUNBOOK.md | sre.google/workbook/canarying-releases |
...
| Anthropic System Card pattern | docs/SYSTEM-CARD-reranker-v1.0.0.md | anthropic.com/rsp |
